  ...
  return (
    <FormStepLayout id="step-1" current={1} className="step-draw">
      ...
      <div className="canvas-wrapper">
        {/* 3-col grid: left banner | card | right col */}
        <div className="canvas-grid">

          {/* Left banner column */}
          <div className="canvas-side canvas-side--left" aria-hidden="true">
            <div className="canvas-banner">Your version</div>
          </div>
          ...
          {/* Right column: pencil on top, banner below */}
          <div className="canvas-side canvas-side--right" aria-hidden="true">
