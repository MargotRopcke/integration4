      ...
      <div className="content">
        ...
        {showPopup && (
          <div className="popup-overlay" id="no-photos-popup">
            <div className="popup-card popup-card--photos">
              <h2 className="popup-title popup-title--photos">Are you sure?</h2>
              <p className="popup-desc popup-desc--photos">
                Taking photos during the experience leads to better outcomes
                and creates a more engaging overall experience.
              </p>
              <div className="popup-actions popup-actions--photos">
                <button
                  className="btn-form btn-form--photos-light"
                ...
                <button
                  className="btn-form btn-form--photos-red"
