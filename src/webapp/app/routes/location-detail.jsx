        ...
        <div className="location-detail__expanded">
          ...
          {location.location_vibes && location.location_vibes.length > 0 && (
            <div className="location-detail__section">
              <h3 className="location-detail__section-title visually-hidden">Vibes</h3>
          ...
          {location.specialization_categories?.image && (
            <div className="location-detail__section" id="location-specialization">
              <h3 className="location-detail__section-title visually-hidden">Specialization</h3>
          ...
          {location.quote && (
            <div className="location-detail__section">
              <h3 className="location-detail__section-title visually-hidden">Quote</h3>
            ...
            <div className="location-detail__button">
              {googleMapsUrl && (
                <a
                  ...
                  id="google-maps-link"
                >
                  <span className="location-detail__button-icon"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
