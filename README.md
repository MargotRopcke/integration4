...
## setup
You just have to download the portal folder in src, the folder webapp is deployed with github so it is not necessary to download that. 
In the portal folder you just need to run 'npm i' and make an .env file like the .env example file and fill in the keys from your database.
