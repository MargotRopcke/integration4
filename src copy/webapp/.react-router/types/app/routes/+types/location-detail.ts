...
type Module = typeof import("../location-detail.js")

type Info = GetInfo<{
  file: "routes/location-detail.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../../layouts/detail-panel.js");
}, {
  id: "routes/location-detail";
  module: typeof import("../location-detail.js");
}];
